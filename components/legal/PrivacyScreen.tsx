    ...
    <main className="legal-page">
      <div className="legal-shell">
        ...
        <article>
          ...
          <p>
            운영자(관리자)는 거래 중개, 문제 상황 확인, 서비스 오류 대응 등 운영 목적상 필요한 범위에서
            거래방의 메시지 내역을 열람할 수 있습니다. 이는 서비스 운영을 위한 회사 내부의 처리이며,
            외부 제3자에게 제공되는 것이 아닙니다.
          </p>
        </article>
        ...
        <article>
          ...
          <ul>
            ...
            <li>거래방은 해당 거래의 딜러·시공점과 운영자(관리자)만 열람할 수 있으며, 그 외 다른 회원은 접근할 수 없습니다.</li>
          </ul>
        </article>
