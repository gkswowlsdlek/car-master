    ...
    try {
      if (role === "dealer") {
        ...
        await onCompleteDealer({
          ...
          activityRegion: form.activityRegion?.trim(),
      ...
      <section className="signup-shell">
        ...
        <div className="signup-role-picker">
          <button className={role === "dealer" ? "active" : ""} onClick={() => setRole("dealer")}>
            ...
            <span>
              <b>딜러로 시작하기</b>
              <small>최소 정보 입력 후 바로 딜러 워크스페이스를 이용합니다.</small>
            </span>
          </button>
          <button className={role === "installer" ? "active" : ""} onClick={() => setRole("installer")}>
            ...
            <span>
              <b>시공점 입점 신청</b>
              <small>상세 정보 제출 후 관리자 승인을 기다립니다.</small>
            </span>
          </button>
        </div>
        <section className="signup-form card">
          ...
          <div className="onboarding-consent">
            <label>
              <input type="checkbox" checked={agreedTerms} onChange={(event) => setAgreedTerms(event.target.checked)} />
              <span>
                [필수]{" "}
          ...
          <button className="primary signup-submit" disabled={busy} onClick={() => void submit()}>
            {busy ? "처리 중..." : role === "dealer" ? "딜러로 시작하기" : "입점 신청하기"}
          </button>
