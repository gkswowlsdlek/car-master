...
export function LandingPage({ onStart, onPriceGuide }: { onStart: () => void; onPriceGuide: () => void }) {
  return <main className="marketing-page">
    ...
    <section className="marketing-hero">
      <div className="marketing-hero-copy"><div className="hero-kicker"><Sparkles size={15} /> 딜러와 시공점을 위한 업무 플랫폼</div><h1>차량 시공 업무를<br /><span>하나의 거래 흐름으로.</span></h1><p className="page-subtitle">흩어진 연락과 파일 대신, 가격 확인부터 시공 완료까지.<br />카마스터가 딜러의 시공 업무를 선명하게 정리합니다.</p><div className="marketing-cta"><button className="button button-primary button-large" onClick={onStart}>카마스터 시작하기 <ArrowRight size={18} /></button><button className="button button-secondary button-large" onClick={onPriceGuide}>가격 가이드 보기</button></div><div className="hero-assurance"><span><ShieldCheck size={16} /> 거래별 기록 관리</span><span><Clock3 size={16} /> 빠른 업무 확인</span></div></div>
    ...
    <footer className="marketing-footer"><div className="footer-brand"><img src="/carmaster-logo-transparent.png" alt="Car-Master" /><p>딜러와 시공점을 하나의 거래 흐름으로 연결합니다.</p></div><div className="footer-meta"><span><small>서비스</small>Car-Master Beta</span><span><small>문의</small>help@car-master.kr</span><span><small>버전</small>v0.3.2 · API 연결 전 마지막 패치</span><span><small>Copyright</small>© 2026 Car-Master</span></div></footer>
  </main>;
}
