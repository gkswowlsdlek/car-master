    ...
    <main className="marketing-page">
      ...
      <section className="marketing-hero">
        <div className="marketing-hero-copy">
          <div className="hero-kicker">딜러와 시공점을 연결하는 업무공간</div>
          <h1>
            전국 어디로 출고해도,
            <br />
            <span>가까운 시공점을 바로 찾으세요.</span>
          </h1>
          <p className="page-subtitle hero-message">
            지역과 필요한 작업 조건으로 시공점을 찾고,
            <br />
        ...
        <div className="hero-product-stack">
          <div className="product-preview" aria-label="카마스터 시공점 찾기 화면 미리보기">
            <div className="preview-window-bar">
              <span />
              <span />
              <span />
              <b>Car-Master Workspace</b>
            </div>
            <div className="preview-app">
              <aside>
                <div className="preview-logo-mark">CM</div>
                {["시공점 찾기", "시공 요청", "거래 관리", "메시지"].map((item, index) => (
              ...
              <section>
                <header>
                  <div>
                    <small>SHOP DISCOVERY</small>
                    <strong>가까운 시공점을 확인하세요</strong>
                  </div>
                  <span>지역 검색</span>
                </header>
      ...
      <section className="trust-strip">
        <span className="primary-benefit">
          <Building2 size={24} /> 전국 시공점 네트워크
        </span>
        <span className="primary-benefit">
          <MapPin size={24} /> 지역·조건으로 검색
        </span>
        <span>
          <MessageCircle size={24} /> 거래방 자동 생성
        </span>
        <span>
          <Clock3 size={24} /> 실시간 진행 관리
        </span>
      </section>
      <section className="marketing-final-cta">
        <p className="eyebrow">READY TO START</p>
        <h2>다음 출고 지역의 시공점부터 찾아보세요.</h2>
        <p className="final-cta-description">
          지역과 작업 조건에 맞는 시공점을 찾고, 시공 요청부터 작업 관리까지 카마스터에서 이어가세요.
        </p>
        <button className="button button-primary button-large" onClick={onStart}>
      ...
      <footer className="marketing-footer">
        <div className="footer-brand">
          <img src="/carmaster-logo-transparent.png" alt="Car-Master" />
          <p>딜러와 시공점을 하나의 거래 흐름으로 연결합니다.</p>
