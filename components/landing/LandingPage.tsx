...
const workflow = ["지역 검색", "시공점 비교", "시공 요청", "전화 확인", "작업 관리"];
...
export function LandingPage({ onStart }: { onStart: () => void }) {
  return <main className="marketing-page">
    ...
    <section className="marketing-final-cta"><p className="eyebrow">READY TO START</p><h2>다음 출고 지역의 시공점부터 찾아보세요.</h2><p className="final-cta-description">지역과 작업 조건에 맞는 시공점을 찾고, 시공 요청부터 작업 관리까지 카마스터에서 이어가세요.</p><button className="button button-primary button-large" onClick={onStart}>카마스터 시작하기 <ArrowRight size={19} /></button></section>
    <footer className="marketing-footer"><div className="footer-brand"><img src="/carmaster-logo-transparent.png" alt="Car-Master" /><p>딜러와 시공점을 하나의 거래 흐름으로 연결합니다.</p><div className="footer-links"><a href="/terms">이용약관</a><span aria-hidden="true">|</span><a href="/privacy">개인정보처리방침</a></div></div><div className="footer-meta"><span><small>서비스</small>Car-Master Beta</span><span><small>문의</small>채널 준비 중</span><span><small>Copyright</small>© 2026 Car-Master</span></div></footer>
  </main>;
}
