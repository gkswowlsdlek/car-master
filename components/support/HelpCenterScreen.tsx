...
export function HelpCenterScreen({ role = "dealer" }: { role?: "dealer" | "shop" }) {
  ...
  return <main className="help-page"><div className="help-shell">
    ...
    <section className="help-quick-grid"><Link href="/help?section=faq"><BookOpen size={20} /><span><b>자주 찾는 도움말</b><small>처음 이용할 때 필요한 안내</small></span><ChevronRight size={17} /></Link><a href="mailto:help@car-master.kr"><MessageCircle size={20} /><span><b>문의하기</b><small>운영팀에 문의가 필요할 때</small></span><ChevronRight size={17} /></a><Link href="/terms"><ShieldCheck size={20} /><span><b>서비스 이용 안내</b><small>약관과 개인정보처리방침</small></span><ChevronRight size={17} /></Link></section>
    ...
    <section className="help-contact"><div><b>원하는 답을 찾지 못하셨나요?</b><p>문의 내용을 남겨주시면 운영팀이 확인 후 안내해 드립니다.</p></div><a className="primary" href="mailto:help@car-master.kr">문의하기</a></section>
  </div></main>;
}
