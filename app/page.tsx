...
export default function Home() {
  ...
  const { sendMessage, markRoomRead, loadContact, hideTransaction, unhideTransaction, changeStage, endOutcome, changeFinalPrice, changePayment } = useTransactionActions({ useSupabaseData, transactions, sharedRoomIds, demoActorId: account.id, role, refresh });
