...
export type PriceGuideFilter =
  "전체" | "버텍스" | "브이쿨" | "솔라가드" | "후퍼옵틱" | "레인보우" | "레이노" | "글라스틴트" | "기타";
...
export const priceGuideFilters: PriceGuideFilter[] = [
  "전체",
  "버텍스",
  "브이쿨",
  "솔라가드",
...
export const pricePackages: PricePackage[] = installationPriceGuide.flatMap((brand) =>
  brand.products.map((product, productIndex) => {
    ...
    return {
      ...
      description:
        product.note ?? "국산 승용차의 썬팅 시공 패키지를 기준으로 한 카마스터 권장 시공 패키지 가이드입니다.",
